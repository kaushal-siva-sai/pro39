...
function preload(){
  ...
  trex_collided = loadAnimation("trex collided ended.png");
  
  groundImage = loadImage("g.png");
  
  cloudImage = loadImage("c.png");
  ...
  cpsound = loadSound("collided.wav")
}

function setup() {
  createCanvas(600, 200);
  
  trex = createSprite(30,20,20,500);
  ...
  obstacle = createSprite(270,20,2,20);
  obstacle.addImage(obstacle1,obstacle2,obstacle4);
